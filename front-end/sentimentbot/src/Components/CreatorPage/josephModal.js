          ...
          <ModalBody>
            <div className="joseph-container">
              ...
              <div className="joseph-link-container">
                <a className="fab fa-twitter-square fa-3x" href="https://twitter.com/_josepheastman" rel="noopener noreferrer" target="_blank"></a>
                <a className="fab fa-github-square fa-3x" href="https://github.com/josepheastman" rel="noopener noreferrer" target="_blank"></a>
                <a className="fab fa-linkedin fa-3x" href="https://www.linkedin.com/in/joseph-eastman/" rel="noopener noreferrer" target="_blank"></a>
              </div>
            </div>
          </ModalBody>
          <ModalFooter>
